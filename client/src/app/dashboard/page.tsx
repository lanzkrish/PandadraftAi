      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        ...
        <Card glass hoverEffect>
          ...
          <div>
            ...
            <p className="font-headline-lg text-headline-lg text-on-surface">112</p>
          </div>
        </Card>
        ...
        <Card glass hoverEffect>
          ...
          <div>
            ...
            <p className="font-headline-lg text-headline-lg text-on-surface">4</p>
          </div>
        </Card>
        ...
        <Card glass hoverEffect className="flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative w-full flex-grow flex items-center justify-center">
            <CircularProgress value={85} size={96} />
          </div>
        </Card>
      </section>
        ...
        <div className="lg:col-span-2 flex flex-col gap-8">
          <Card glass hoverEffect={false}>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-4 p-4 rounded-lg hover:bg-white/40 transition-colors group cursor-pointer border border-transparent hover:border-white/60">
                <div className="w-12 h-12 rounded-lg bg-surface flex items-center justify-center flex-shrink-0">
                  <span className="material-symbols-outlined text-primary">edit_document</span>
                </div>
                <div className="flex-grow">
                  <h4 className="font-body-lg text-body-lg font-medium text-on-surface">10 ways to optimize SaaS pricing</h4>
                  <div className="flex items-center gap-2 mt-1">
                    <Badge variant="glass">LinkedIn</Badge>
                    <span className="font-body-sm text-body-sm text-on-surface-variant">Today, 2:00 PM</span>
                  </div>
                </div>
